...
ws = NaN; % Initialises ws to a value which is not valid so that the while loop is entered
...
fcUser = NaN; % Initialises fcUser to a value which is not valid so that the while loop is entered
