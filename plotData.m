...
plot(t, yFinal, 'color', 'k'); % Plots the time domain waveform of the processed file
...
subplot(4,2,5); % Targets the lower middle left axes
stem(hd, 'color', 'k');
xlim([0 ws]);
title("Basic Filter Response");

subplot(4,2,6); % Targets the lower middle right axes
stem(h, 'color', 'k');
xlim([0 ws]);
title("Filter Coefficients");

subplot(4,2,7); % Targets the bottom left axes
...
subplot(4,2,8); % Targets the bottom right axes
