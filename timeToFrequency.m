...
yAmpInit = yAmpInit(1:floor(length(yAmpInit)/2),channelNum)*2; % Halves the length of the array to remove the symmetrical points and doubles the amplitudes to redistribute the energy from the removed points

yAmpProcessed = yAmpProcessed(1:floor(length(yAmpProcessed)/2),channelNum)*2; % Halves the length of the array to remove the symmetrical points and doubles the amplitudes to redistribute the energy from the removed points
